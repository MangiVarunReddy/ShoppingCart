		...
		<table class="table table-light">
			...
			<% if(session_cart_list!=null){
				for(Cart n:cartProduct){%>
					...
					<td><%=n.getName() %></td>
					<td><%=n.getCategory() %></td>
					<td><%=dcf.format(n.getPrice())%>$</td>
					<td>
						<form action="order-now" method="post" class="form-inline frm">
					...
					<td><a class="btn btn-sm btn-danger" href="removeItem?id=<%=n.getId()%>">Remove</a></td>
				</tr>
				<%}
